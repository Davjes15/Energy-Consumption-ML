The idea of this project is to create a ML model that predicts the consumption of energy in kWh based on the "Residential Energy Consumption Survey (RECS)"
